...
import com.aliyun.vpaas.standard.ecommerce.view.LiveMoreView
...
class GiftAnimationUtil {
    ...
    companion object {
        ...
        fun showAnimation(activity: Activity, type: String?) {
            val gift = when (type) {
                LiveMoreView.SEND_GIFT_TYPE_FLOWER -> {
                    R.drawable.icon_flower
                }
                LiveMoreView.SEND_GIFT_TYPE_BOAT -> {
                    R.drawable.icon_boat
                }
                LiveMoreView.SEND_GIFT_TYPE_PLANE -> {
                    R.drawable.icon_plane
                }
                LiveMoreView.SEND_GIFT_TYPE_ROCKET -> {
