//
//  ASLRBAudienceLiveRoomBottomViewHolder.m
//  AliStandardLiveRoomBundle
//
//  Created by fernando on 2021/11/16.
//

#import "ASLRBAudienceLiveRoomBottomViewHolder.h"
...
@interface ASLRBAudienceLiveRoomBottomViewHolder()<UITextFieldDelegate>

@property (assign, nonatomic) BOOL rotated;

@end

@implementation ASLRBAudienceLiveRoomBottomViewHolder
...
//    void (^animation)(void) = ^void(void) {
        ...
        self.commentInputField.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.7];
