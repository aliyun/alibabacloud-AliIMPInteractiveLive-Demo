...
@interface SECLRAGiftsViewController ()
@property (strong, nonatomic) UILabel* headerTitleLabel;
@property (strong, nonatomic) SECLRAInteractionButton* rocket;

@end

@implementation SECLRAGiftsViewController
...
- (SECLRAInteractionButton*)rocket {
    if (!_rocket) {
        _rocket = [[SECLRAInteractionButton alloc] init];
