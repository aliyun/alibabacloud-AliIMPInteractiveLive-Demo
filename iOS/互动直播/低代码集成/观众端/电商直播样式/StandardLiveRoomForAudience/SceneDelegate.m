...
#import "MockTaobaoLive/ASLUKECommerceLiveRoomWrapper.h"
...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    ASLUKECommerceLiveRoomWrapper* ecommerceLiveRoomWrapper = [[ASLUKECommerceLiveRoomWrapper alloc] init];
    
    __weak typeof(self) weakSelf = self;
    [ecommerceLiveRoomWrapper setupLiveRoomWithAppID:[AIRBDEnvironments shareInstance].interactiveLiveRoomAppID
