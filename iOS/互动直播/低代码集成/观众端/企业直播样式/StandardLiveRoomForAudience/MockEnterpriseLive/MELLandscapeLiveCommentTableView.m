...
#import "MELLandscapeLiveCommentCell.h"
#import "ASLUKEdgeInsetLabel.h"
#import <Masonry/Masonry.h>
#import "UIColor+ColorWithHexString.h"

@interface MELLandscapeLiveCommentTableView ()<UITableViewDelegate,UITableViewDataSource>
...
static NSString* _Nonnull reuseableCellId = @"MELLandscapeLiveCommentCell";

@implementation MELLandscapeLiveCommentTableView
...
//        self.estimatedRowHeight = 0;
        ...
        [self registerClass:[MELLandscapeLiveCommentCell class] forCellReuseIdentifier:reuseableCellId];
...
- (CGSize)getTextSizeWithCommentModel:(ASLRBLiveCommentModel*)model {
    NSDictionary *atrri = @{NSFontAttributeName: [UIFont fontWithName:@"PingFangSC-Regular" size:12]};
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MELLandscapeLiveCommentCell* cell = [self dequeueReusableCellWithIdentifier:reuseableCellId];
    if(cell == nil){
        cell = [[MELLandscapeLiveCommentCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseableCellId];
    }
//    cell.delegate = self;
//    cell.config = _config;
