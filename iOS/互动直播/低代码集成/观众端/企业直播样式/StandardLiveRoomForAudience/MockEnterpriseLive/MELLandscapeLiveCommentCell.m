...
@interface MELLandscapeLiveCommentCell()
...
@implementation MELLandscapeLiveCommentCell
...
- (void)setCommentModel:(ASLRBLiveCommentModel *)commentModel{
    ...
    self.commentLabel.backgroundColor = [UIColor colorWithHexString:@"#000000" alpha:0.6];
    ...
    [self.commentLabel setFont:[UIFont fontWithName:@"PingFangSC-Regular" size:12]];
